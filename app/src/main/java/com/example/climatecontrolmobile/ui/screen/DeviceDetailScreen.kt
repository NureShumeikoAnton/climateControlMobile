...
@Composable
private fun DeviceInfoCard(device: com.example.climatecontrolmobile.data.model.Device?) {
    Card(
        modifier = Modifier.fillMaxWidth()
    ) {
        Column(
            ...
            Spacer(modifier = Modifier.height(16.dp))
              device?.let {
                ...
                InfoRow("Power", "${it.power}%")
                InfoRow("Mode", it.mode)
